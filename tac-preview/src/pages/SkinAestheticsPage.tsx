  ...
  return (
    <div ref={root}>
      ...
      {/* BRAND AMBASSADOR — Milind Soman. Light cream section so it
          breaks the dark 'Why Choose' band → CtaBand sequence.
          Mandatory '· BRAND AMBASSADOR · TLC' attribution on the
          portrait. */}
      <section className="relative bg-cream/50 px-6 md:px-12 py-16 md:py-24 overflow-hidden fade-up">
        <div
          aria-hidden
          className="absolute inset-0 pointer-events-none"
          style={{
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto grid md:grid-cols-[1.05fr_0.95fr] gap-10 md:gap-16 lg:gap-20 items-center">
          ...
          <figure className="relative rounded-[22px] overflow-hidden ring-1 ring-ink/10 shadow-[0_40px_85px_-38px_rgba(27,26,24,0.4)] bg-gradient-to-b from-white to-[#efe7dd] order-1 md:order-none">
          ...
          <div>
            ...
            <p className="font-display italic text-rust text-[16px] md:text-[19px] leading-[1.45] mb-7 max-w-[500px]">
              &ldquo;Looking good at any age starts with being well at every
              age.&rdquo;
            </p>
            <a
              href="/contact"
