...
const ABOUT_META = {
  ...
  jsonLd: [
    ...
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Person',
      '@id': 'https://thelongevitycentre.co/about-us#dr-abhinav-sharma',
      ...
      image: 'https://thelongevitycentre.co/team/dr-abhinav.jpg',
      worksFor: { '@id': 'https://thelongevitycentre.co/#organization' },
      knowsAbout: [
        'Anti-Aging Medicine',
        'Preventive Medicine',
    ...
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Person',
      '@id': 'https://thelongevitycentre.co/about-us#dr-bhavna-sharma',
      ...
      image: 'https://thelongevitycentre.co/team/dr-bhavna-2026.jpg',
      worksFor: { '@id': 'https://thelongevitycentre.co/#organization' },
      knowsAbout: [
        'IVF',
        "Women's Health",
