...
export const DIAGNOSTICS: Diagnostic[] = [
  ...
  },
  {
    ...
    category: 'Skeletal',
    duration: '15 minutes',
    sampleType: 'DEXA scan (in-clinic)',
    ...
    whatItIs: {
      ...
      body: [
        ...
        'DEXA (Dual-energy X-ray Absorptiometry) is the diagnostic gold standard. We measure spine, hip and forearm density and return T-scores, Z-scores, and a FRAX 10-year fracture risk projection.',
      ],
    },
    whySuperior: {
      title: 'Why DEXA, not a heel-ultrasound screener',
      intro:
        'Pharmacy and gym ultrasound screens are screening tools, not diagnostics. DEXA is the clinical reference.',
      points: [
        'Multi-site measurement (spine + hip + forearm) — gold standard',
        'Returns T-scores, Z-scores, and FRAX 10-year fracture risk',
        'Diagnostic-grade — accepted by every endocrinology guideline globally',
        'Low radiation — equivalent to a single transatlantic flight',
        'Trackable year-over-year for true skeletal-age progression',
      ],
    },
    benefits: [
      'Catch osteopenia and early osteoporosis before fractures occur',
      ...
      'Stratify your fracture risk over the next decade with FRAX',
    ...
    process: [
      {
        n: '01',
        title: 'Scan',
        body: 'Lie on the DEXA bed. The arm passes overhead, scanning spine, hip and forearm. Total time: 15 minutes.',
      },
      {
        n: '02',
        title: 'Score',
        body: 'T-score (vs. peak adult bone), Z-score (vs. age-matched), and FRAX 10-year fracture risk returned.',
      },
      {
        n: '03',
        title: 'Protect',
        body: 'A precision bone-preservation protocol — strength training, micronutrient repletion, hormonal support if indicated.',
      },
    ],
    whoFor: [
    ...
    technical: [
      { k: 'Method', v: 'Dual-energy X-ray absorptiometry (DEXA)' },
      { k: 'Sites measured', v: 'Lumbar spine + hip + forearm' },
      { k: 'Output', v: 'T-score · Z-score · FRAX 10-year risk' },
      { k: 'Radiation', v: 'Very low (equivalent to one transatlantic flight)' },
      { k: 'Re-test', v: 'Every 12–24 months depending on baseline' },
    ],
