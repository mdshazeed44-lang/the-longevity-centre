...
export const SKIN_TREATMENTS: SkinTreatment[] = [
  ...
  {
    slug: 'cool-sculpting',
    shortName: 'CoolSculpting',
    category: 'Body Contouring',
    title: 'CoolSculpting',
    eyebrow: 'Non-Invasive Fat Reduction',
    image: '/skin-aesthetics/09-coolsculpting.jpg',
    description:
      "CoolSculpting is a non-invasive fat reduction treatment that freezes and eliminates unwanted fat cells through advanced cryolipolysis. Our CE (Europe) certified CoolTech machine from Spain targets stubborn pockets of fat — abdomen, love handles, thighs — that resist diet and exercise. Treated fat cells are eliminated naturally by the body and do not regenerate.",
    treats: [
      'Stubborn belly fat',
      'Love handles',
      'Thigh and outer-leg fat pockets',
      'Post-pregnancy abdominal fat',
    ],
    benefits: [
      'Up to 20% fat reduction in treated areas',
      'Permanent — eliminated fat cells do not return',
      'Non-invasive, no surgery, no downtime',
      'Natural-looking results',
      'CE-certified European technology',
    ],
    duration: '1–3 sessions, 2–3 months apart · 30–60 min per session',
    note: 'Noticeable improvements within 3 weeks; full results visible after 2–3 months.',
    process: [
      {
        n: '01',
        title: 'Consult & assess',
        body: 'A physician assesses the fat pockets, takes baseline measurements and photographs, and confirms you are a candidate for cryolipolysis.',
      },
      {
        n: '02',
        title: 'Applicator placement',
        body: 'The treatment area is marked and the appropriate CoolTech applicator is positioned. Vacuum suction draws tissue into the device for uniform cooling.',
      },
      {
        n: '03',
        title: 'Controlled cooling',
        body: 'Fat cells are cooled to a precise temperature for 30–60 minutes. The cold selectively crystallises fat cells without harming surrounding tissue.',
      },
      {
        n: '04',
        title: 'Natural elimination',
        body: 'Over the following weeks, crystallised fat cells are gradually cleared by the body. Results emerge from 3 weeks and continue improving to month 3.',
      },
    ],
  },
  {
    ...
    title: 'Viora RF',
    eyebrow: 'Radiofrequency Skin Tightening',
    image: '/skin-aesthetics/10-viora-rf.jpg',
    description:
      'Viora RF is a non-invasive radiofrequency treatment for skin tightening, cellulite reduction and stretch-mark improvement. The advanced RF technology heats deep dermal layers to stimulate collagen production, restoring elasticity and firmness. CE (Europe) certified and FDA cleared — particularly effective for post-delivery lax abdominal skin and post-fat-loss loose skin.',
    treats: [
      'Sagging or lax skin',
      'Cellulite on thighs and glutes',
      'Stretch marks (post-pregnancy or post-weight-loss)',
      'Loss of facial firmness',
    ],
    benefits: [
      'Stimulates collagen for visible tightening',
      'Improves skin texture and elasticity',
      'Minimises stretch marks and scarring',
      'Painless with no downtime',
      'CE-certified, FDA-approved technology',
    ],
    duration: '3–6 sessions, 4–6 weeks apart · 30–60 min per session',
    note: 'Noticeable improvements within 2–4 weeks. Safe for face, abdomen, arms, legs and glutes.',
    process: [
      {
        n: '01',
        title: 'Consult & map',
        body: 'A clinician evaluates skin laxity, identifies treatment zones (abdomen, thighs, face, etc.) and plans the session count based on goals.',
      },
      {
        n: '02',
        title: 'Prep',
        body: 'The treatment area is cleansed and a thin layer of conducting gel is applied. Comfort settings are calibrated to your tolerance — heat warms but never burns.',
      },
      {
        n: '03',
        title: 'RF delivery',
        body: 'The Viora handpiece glides over the skin, delivering controlled radiofrequency energy that heats dermal collagen to the contraction threshold.',
      },
      {
        n: '04',
        title: 'Follow-up',
        body: 'Photographic comparison after every 2 sessions. Collagen remodelling continues for weeks after each treatment — final results build through the series.',
      },
    ],
  },
  {
    slug: 'wonder-muscle',
    shortName: 'Wonder Muscle',
    category: 'Muscle Sculpting',
    title: 'Wonder Muscle',
    eyebrow: 'Electromagnetic Muscle Toning',
    image: '/skin-aesthetics/11-wonder-muscle.jpg',
    description:
      "Wonder Muscle uses advanced Electromagnetic Pulse (EMP) technology — imported from Spain — to stimulate deep muscle contractions equivalent to 20,000 crunches in a single 30-minute session. The non-invasive, pain-free treatment targets specific muscle groups (abdomen, glutes, arms, legs) to build mass, definition and tone. CE (Europe) certified and FDA approved.",
    treats: [
      'Weak or undefined abdominal muscles',
      'Loss of muscle tone after weight loss',
      'Glute lift and definition',
      'Arm and leg muscle sculpting',
    ],
    benefits: [
      'Tones and strengthens targeted muscle groups',
      'Reduces body-fat percentage during the series',
      'Enhances posture and reduces muscle tension',
      'Equivalent to 20,000 crunches per session',
      'Pain-free, no downtime — clothed treatment',
    ],
    duration: '2–4 sessions, 5–7 days apart · 30 min per session',
    note: 'Noticeable improvements within 2–4 weeks. Pairs well with CoolSculpting (fat first, muscle second) for complete body contouring.',
    process: [
      {
        n: '01',
        title: 'Consult & goal-set',
        body: "A physician defines the target zones — abs, glutes, arms or legs — and sets realistic expectations based on your starting muscle baseline.",
      },
      {
        n: '02',
        title: 'Applicator fit',
        body: "EMP applicators are positioned over the chosen muscle groups. You remain fully clothed and lie comfortably during the session.",
      },
      {
        n: '03',
        title: 'EMP stimulation',
        body: 'High-intensity electromagnetic pulses trigger supramaximal muscle contractions — far beyond what voluntary exercise can produce — for the full 30 minutes.',
      },
      {
        n: '04',
        title: 'Build the series',
        body: 'Sessions are spaced 5–7 days apart so muscle fibres have time to recover and grow. Progress is photographed and measured between sessions.',
      },
    ],
  },
]
